    ...
    <li key={i}>
      <a href={href} className='hover:text-white transition-colors'>
        {label}
              ...
              <ul className="space-y-2 text-sm">
                {[
                  { label: 'Conditions générales', href: '/mentions-legales#conditions-generales' },
                  { label: 'Politique de confidentialité', href: '/mentions-legales' },
                  { label: 'Mentions légales', href: '/mentions-legales#mentions-legales' },
                ].map(({ label, href }, i) => (
                  <li key={i}>
